...
public class Anygrow2Server extends WebSocketServer {
   ...
   private void startSerialReader() {
    ...
    public static void main(String[] args) {
        ...
        // ★ HTTP 서버 추가 (웹 UI / API)
        try {
            AnygrowHttpServer http = new AnygrowHttpServer("0.0.0.0", httpPort);
            http.start();
        } catch (Exception e) {
